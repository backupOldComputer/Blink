...
together: src/MS2Frame.class
	java src.MS2Frame 'picture/S/TA (54)' | ffmpeg -r `cat config/rNoLine` -i pipe:0 -stream_loop -1 -i audio/扯.mp3 -vcodec libx264 -pix_fmt yuv420p -acodec aac -y video/av.mp4
